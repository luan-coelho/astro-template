...
export const actionButtoncolorClasses = {
    purple: "border border-purple-500 bg-purple-100 text-purple-500 hover:border-purple-500 hover:bg-purple-100 hover:text-purple-500 rounded-full size-9",
    ...
    green: "border border-green-500 bg-green-100 text-green-500 hover:border-green-500 hover:bg-green-100 hover:text-green-500 rounded-full size-9",
